...
public class AccesoHibernate {
    ...
    public void consultaEquipo() {
    	...
    	TypedQuery<Equipo> q= session.createQuery("select e from Equipo e");
    ...
    public void consultaJugadorPosicion() {
        ...
        while (jugadoresIterator.hasNext()){
            ...
            if(idJug != auxId){
            	System.out.println ( "(" + j.getNumero() + ") " + j.getNombre() + " (" + j.getEquipo().getNombre() + ") " );
            }
